function New-EmployeeOnboardUser {
	...
	.EXAMPLE
		PS> New-EmployeeOnboardUser -FirstName 'John' -MiddleInitial 'A' -LastName 'Smith' -Title 'Manager'
...
function Set-MyAdUser {
	...
	.EXAMPLE
		PS> Set-MyAdUser -Username John -Attributes @{'givenName' = 'James'; 'DisplayName' = 'James Smith'; 'Title' = 'Executive'}
	
		This example changes the givenName to 'James', the display name to 'James Smith' and the title to 'Manager' for the username 'John'
	.PARAMETER Username
...
function Set-MyAdComputer {
	...
	.EXAMPLE
		PS> Set-MyAdComputer -Computername 'Acct01' -Attributes @{'Location' = 'Dallas'; 'Description' = 'Accounting PC'}
	
		This example changes the location to Dallas and the description of the AD computer 'Acct01' to 'Accounting PC'
...
function New-EmployeeOnboardComputer {
	...
	.EXAMPLE
		PS> New-EmployeeOnboardComputer -Computername 'Acct01' -Location "OU = 'Corporate Computers"
	
		This example creates an AD computer.
	.PARAMETER Computername
